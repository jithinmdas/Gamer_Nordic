...
#define TARGET_DEV_NAME                  "Gamer"                                    /**< Target device name that application is looking for. */
...
#define SCHED_MAX_EVENT_DATA_SIZE        10	//BLE_STACK_HANDLER_SCHED_EVT_SIZE
...
/**@brief Function for handling errors of UART.
 * @param[in] p_event 	Contains event type
 */
void uart_event_handle(app_uart_evt_t * p_event)
{
